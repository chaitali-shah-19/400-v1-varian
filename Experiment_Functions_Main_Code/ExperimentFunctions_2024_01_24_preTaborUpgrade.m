...
%                                     fmirror_LRpos = fmirror(1).moveAbsolute(-22920); %Absolute Coil Pos [data]
%                                     fmirror_UDpos = fmirror(2).moveAbsolute(60129); %Absolute Coil Pos [data]
...
%                                 disp('Wrote Sage write 4: Move down and read the data in');
                                ...
                                wait(t);
% 
%                                 fmirror_LRpos = fmirror(1).moveAbsolute(-24207); %Absolute Hyperpolarize Pos [data]
%                                 fmirror_UDpos = fmirror(2).moveAbsolute(60837); %Absolute Hyperpolarize Pos [data]
